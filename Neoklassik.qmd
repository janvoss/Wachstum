...
Kapitalstock pro Kopf bleibt konstant, wenn gilt $I=sY=s{\left(\frac{K}{N}\right)}^{\alpha }=\left(\delta +n\right)\left(\frac{K}{L}\right)$
...
Wenn gilt: $y=A(\frac{K}{L})^\alpha$, dann wächst das Pro-Kopf-Einkommen mit der Rate $g$.
